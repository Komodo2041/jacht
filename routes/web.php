...
Route::match(["get", "post"], '/cruises/clients/{id}', "App\Http\Controllers\CruisesController@clients" );
Route::get('/cruises/clients/{id}/delete/{cid}', "App\Http\Controllers\CruisesController@cruises_delete" );
